...
aws ssm put-parameter --name /figgy/deployments/cloud_version_requirement --type "String" --value "$version" --region 'us-east-1' --overwrite || die "Error updating figgy cloud version requirement in ParameterStore"
