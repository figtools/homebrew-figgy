...
def copy_versioned_objects(version: str, architecture: str, bottle_version: int):
    new_obj = s3_rsc.Object(FIGGY_BUCKET,
                            f'bottles/figgy@{version}-{version}.{architecture}.bottle.{bottle_version}.tar.gz')
...
def create_bottle(version: str, architecture: str, bottle_version: int):
    ...
    new_obj = s3_rsc.Object(FIGGY_BUCKET,
                            f'bottles/figgy-{brewified_version}.{architecture}.bottle.{bottle_version}.tar.gz')
